...
const AddProduct = () => {
    ...
    const { product_name, product_price, product_description, countInStock, product_image, category } = productData
    ...
    const handleSubmit=async e=>{
        ...
        try{
            ...
            const response= await axios.post(`${API_URL}/api/postproduct`,formData,config)
            setSuccess(true)
            setProductData({
                product_name: '',
                product_price: '',
